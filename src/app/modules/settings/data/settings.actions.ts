...
export const toggleFocusMode = createAction('[Settings] Toggle Focus Mode');
...
export const toggleBoxedLayout = createAction('[Settings] Toggle Boxed Layout');
export const togglePushContent = createAction('[Settings] Toggle Push Content');
export const toggleNoOverlay = createAction('[Settings] Toggle No Overlay');
export const toggleOffCanvas = createAction('[Settings] Toggle Off Canvas');
...
export const appReset = createAction('[Settings] App Reset');
export const factoryReset = createAction('[Settings] Factory Reset');
